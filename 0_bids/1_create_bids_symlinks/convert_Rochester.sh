...
# Inputs:
#   Source: Rochester
#     Two sub-folders: CBP and Healthy. But not the same numbers
#     Names are, for instance: sub-1009
#
# Output: bids/sub-Roch*
#
...
main_folder=CLBP_Databases/Rochester
...
do
    ...
    subfolder=${old_name%%/*}
    old_name=${old_name#CBP/}
    old_name=${old_name#Healthy/}

    # --- Extracting number only
    number=${old_name#sub-}

    # --- New name
    new_name=sub-Roch$number
...
echo "Done. Please verify the symlinks: tree $bids/sub-Roch*"
